...
import haibison.android.pattern.Config;
...
public class PostData {
    ...
    class PostRequestExecutor extends AsyncTask<haibison.android.pattern.server.PostRequest, String, String> {

        @Override
        protected String doInBackground(haibison.android.pattern.server.PostRequest... uri) {
